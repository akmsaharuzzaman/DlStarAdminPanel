        ...
        <Table>
          ...
          <TableBody>
            {users.map((user) => (
              ...
              >
                <TableCell className="text-gray-700 text-sm">{user.id}</TableCell>
                <TableCell>
                ...
                <TableCell className="text-gray-700 text-sm">{user.name}</TableCell>
                <TableCell className="text-gray-700 text-sm">{user.uniqueId}</TableCell>
                <TableCell className="text-gray-700 text-sm">{user.gender}</TableCell>
                <TableCell className="text-red-600 text-sm">{user.rcoin}</TableCell>
                <TableCell className="text-green-600 text-sm">{user.country}</TableCell>
                <TableCell>
                ...
                <TableCell className="text-gray-700 text-sm">{user.isHost}</TableCell>
                <TableCell className="text-gray-700 text-sm">{user.agency}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
